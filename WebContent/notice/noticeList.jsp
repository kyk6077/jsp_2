...
<div class="container-fluid">
	...
	<table class="table list_table">
		<tr class="active"><td>NO</td><td>SUBJECT</td><td>NAME</td><td>DATE</td><td>HIT</td></tr>
		<%for(int a=0;a<ntList.size();a++){%>
		<tr><td><%= ntList.get(a).getNum() %></td>
		<td id="td_title"><a href="noticeSelectOne.jsp?num=<%= ntList.get(a).getNum()%>">
			<%= ntList.get(a).getTitle() %></a></td>
		<td><%= ntList.get(a).getWriter() %></td>
		<td><%= ntList.get(a).getReg_date() %></td>
		<td><%= ntList.get(a).getHit() %></td></tr>
		<%}%>
	</table>
